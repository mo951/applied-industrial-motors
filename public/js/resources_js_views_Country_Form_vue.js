...
var brandservice = new _services_auth_default__WEBPACK_IMPORTED_MODULE_1__["default"]('countries');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              res = _context.sent;
              _this.form = {
                country_name: res.country_name ? res.country_name : '',
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                formdata.append("country_name", this.form.country_name);
              ...
              case 18:
                if (!res.status) {
                  if (res.data.country_name) {
                    this.errors.country_name = res.data.country_name;
                  }

                  if (res.data.country_code) {
                    this.errors.country_code = res.data.country_code;
                  }
                    ...
                    [
                        ...
                        [
                          _c("v-text-field", {
                            attrs: {
                              ...
                              "error-messages": _vm.errors.country_code,
                              label: "Country Code",
                            },
                            model: {
                      ...
                      _c(
                        ...
                        [
                          _c("v-text-field", {
                            attrs: {
                              "error-messages": _vm.errors.country_name,
                              label: "Country Name",
                            },
                            model: {
